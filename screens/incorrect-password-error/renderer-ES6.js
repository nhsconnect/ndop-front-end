...
function getIncorrectPasswordErrorComponent() {
  return IncorrectPasswordError;
}

class IncorrectPasswordError extends React.Component {
  render() {
    return (
      <html lang="en-GB">
        <head>
        ...
        <body id="mainBody">
          ...
          <main id="mainContent" role="main">
            <div className="page-section">
              ...
              <p>The password entered is incorrect.</p>
              <p>Please try again.</p>
              <a id="returnButton" role="button" className="button" href={CONFIG.ENTER_PASSWORD_ENDPOINT}>Return to the enter password page</a>
            </div>
          </main>
