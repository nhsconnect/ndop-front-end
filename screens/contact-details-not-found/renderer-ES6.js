...
function renderHtml() {
  ...
  var contactDetailsNotFoundComponent = getContactDetailsNotFoundComponent();
  var ComponentFactory = React.createFactory(contactDetailsNotFoundComponent);
...
function getContactDetailsNotFoundComponent() {
  return ContactDetailsNotFound;
}

class ContactDetailsNotFound extends React.Component {
  render() {
    return (
      <html lang="en-GB">
        <head>
          ...
          <title>No contact details found - {CONFIG.SERVICE_NAME}</title>
              ...
              <div className="reading-width">
                <div className="grid-row">
                  <div className="column--two-thirds">
                    <h1 id="contactDetailsNotFoundTitle" className="h2">No contact details found</h1>
                    <p>
                      Thanks, we&apos;ve found your details, but we could not find a mobile number or email address.
                    </p>
                    <p>
                      This may be because you have not registered these details with your GP Practice, or your GP Practice has not yet shared them with us.
                    </p>
                    <p>
                      You can try again when your information is updated, or you can choose to use the non-digital service instead.
                    </p>
                    <p>Please see <a href={CONFIG.OTHER_WAYS_TO_SET_YOUR_PREFERENCES_ENDPOINT}>other ways to manage your choice</a>.</p>
                  </div>
                </div>
              </div>
            </div>
