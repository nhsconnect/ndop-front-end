...
function renderHtml() {
  ...
  var reviewYourChoiceComponent = getReviewYourChoiceComponent();
  var ComponentFactory = React.createFactory(reviewYourChoiceComponent);
...
function getReviewYourChoiceComponent() {
  return ReviewYourChoice;
}
    ...
    return (
      <html lang="en-GB">
        <head>
          ...
          <title>Review your choice - {CONFIG.SERVICE_NAME}</title>
        ...
        <body id="mainBody">
          ...
          <script type='text/javascript' src={CONFIG.STATIC_RESOURCES_CDN_URL + '/js/app/reviewyourchoice.bundle.js'}></script>
        </body>
      </html>
    );
  }
