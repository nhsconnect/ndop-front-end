...
function renderHtml(context) {
  ...
  var component = geSetPreferenceErrorComponent();
...
function geSetPreferenceErrorComponent() {
    ...
    return (
      <html lang="en-GB">
        <head>
          ...
          <title>Sorry, you cannot make your choice right now - {CONFIG.SERVICE_NAME}</title>
