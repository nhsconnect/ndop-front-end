...
class ExpiredOtp extends React.Component {
  render() {
    return (
      <html lang="en-GB">
        <head>
          ...
          <title>Your code has expired - {CONFIG.SERVICE_NAME}</title>
        ...
        <body id="mainBody">
          ...
          <script type='text/javascript' src={CONFIG.STATIC_RESOURCES_CDN_URL + '/js/app/expiredcodeerror.bundle.js'}></script>
