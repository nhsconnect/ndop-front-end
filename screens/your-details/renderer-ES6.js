...
function getHeaderAndFooterComponent() {
    ...
    return (
      <html lang="en-GB">
        <head>
          ...
          <script type='text/javascript' src={CONFIG.STATIC_RESOURCES_CDN_URL + '/js/lib/details.js'}></script>
        </head>
        <body id="mainBody">
          <div className="skiplinks">
            <div className="skiplinks__inner">
              <a id="skipToContentLink" href="" className="skiplinks__link">Skip to main content</a>
            </div>
          </div>
          ...
          <script type='text/javascript' src={CONFIG.STATIC_RESOURCES_CDN_URL + '/js/app/yourdetails.bundle.js'}></script>
