...
function renderHtml() {
  ...
  var preferenceSelectorComponent = getPreferenceSelectorComponent();
  var ComponentFactory = React.createFactory(preferenceSelectorComponent);
...
function getPreferenceSelectorComponent() {
    ...
    return (
      <html lang="en-GB">
        <head>
          ...
          <title>Make your choice - {CONFIG.SERVICE_NAME}</title>
        ...
        <body id="mainBody">
          ...
          <script type='text/javascript' src={CONFIG.STATIC_RESOURCES_CDN_URL + '/js/app/setyourpreferences.bundle.js'}></script>
