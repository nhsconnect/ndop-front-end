            ...
            <div className="page-section" id="page-content">
              <div className="grid-row">
                <div className="column--two-thirds">
                  <h1 className="h2">Oops! Something went wrong.</h1>
                  <p>Sorry, there seems to be a problem. It&apos;s not you, it&apos;s us!</p>
                  <p>Please try again later</p>
                  <a id="returnButton" role="button" className="button" href={CONFIG.LANDING_PAGE_ENDPOINT}>Return to the start page</a>
                </div>
              </div>
            </div>
          </main>
